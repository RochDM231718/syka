...
from app.schemas.admin.auth import ResetPasswordSchema, RegisterSchema
...
@router.get('/register', response_class=HTMLResponse, name='register.form')
...
@router.post('/register', response_class=HTMLResponse, name='register.store')
async def register_store(
    ...
    try:
        ...
        success = auth_service.register(data)

        if success:
            return templates.TemplateResponse('auth/sign-in.html', {
                "request": request,
                "error_msg": "Account created! Please sign in. Wait for moderation approval.",
